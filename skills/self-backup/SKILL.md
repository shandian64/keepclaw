...
name: self-backup
description: >-
  Backup important OpenClaw workspace files to a GitHub repository. Use when:
  (1) user wants to backup workspace configuration, (2) sync OpenClaw settings
  to GitHub, (3) preserve automation scripts and personal configuration,
  (4) create remote backup of AGENTS.md, SOUL.md, MEMORY.md, and other
  workspace files. Configurable for any GitHub repository.
metadata: { "openclaw": { "emoji": "💾", "requires": { "bins": ["gh", "git", "jq"] } } }
---
